...
function ResetPassword() {
  ...
  return (
    <div className='flex flex-col gap-10 justify-center items-center p-20'>
      ...
      <form onSubmit={handleResetPassword} className='w-1/3 flex flex-col gap-10 justify-center items-center p-10 border border-black rounded-md'>
        ...
        <div className='flex flex-col w-full gap-3'>
          ...
          <label className='text-gray-600'>password should atleast 6 characters</label>
        </div>
        <div className='flex flex-col w-full gap-3'>
